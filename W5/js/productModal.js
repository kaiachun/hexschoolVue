export default {
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="h5" v-if="tempProduct.price">限時特價 {{ tempProduct.price }} 元</div>
              <div>
  ...
  props: ['product'],  // 用 tempProduct 做接收
  data() {
    return {
      status: {},
      tempProduct: {},
  ...
  watch: {
    // 監聽 product 變化並把資訊寫入 tempProduct
    product() {
      this.tempProduct = this.product;
    }
  },

  mounted() {  // 建立 Modal 的生命週期，對應到 Bootstrap Modal
